...
public enum SlooceSMPPProvider {
    ...
    MBLOX_ATLAS(TAG_MBLOX_OPERATOR, false, Alphabet.ALPHA_LATIN1, DataCodings.ZERO, 30000 /* 60 sec inactivity timeout */, 20000 /* sometimes takes 14 sec to get response */),
